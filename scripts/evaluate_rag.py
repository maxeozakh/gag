...
def main():
    ...
    parser.add_argument("--llm_model", type=str, default="gpt-3.5-turbo", help="OpenAI model for generation")
    parser.add_argument("--eval_model", type=str, default="gpt-3.5-turbo", help="OpenAI model for evaluation")
